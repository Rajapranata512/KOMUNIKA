...
export default async function AdminUsersPage({
  ...
  searchParams: Promise<{ q?: string; cursor?: string; updated?: string; error?: string }>;
}) {
    ...
    <main id="main-content" className="admin-shell">
      ...
      {params.error ? (
        <div className="form-error" role="alert">
          Status tidak dapat diperbarui. Akun sendiri atau administrator aktif terakhir tidak dapat
          dinonaktifkan.
        </div>
      ) : null}
