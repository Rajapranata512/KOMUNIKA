...
- **2026-08-22:** Cleaned all non-admin identities from production after transferring the fictional demo journal, thirty submissions, and thirty publication versions to the active administrator; verified that exactly two protected administrator identities and the three-issue/thirty-article demo archive remain; added CSRF-protected, confirmed, audited CMS deletion for record-free non-admin accounts with server-side administrator and scholarly-record protection; and passed integration, browser, accessibility, visual, type, lint, unit, and production-build gates.
